...
def get_pipeline(args):
    ...
    if args.unet_path is not None:
        pipe.unet = UNet2DConditionModel.from_pretrained(args.unet_path, subfolder='unet_target')
...
def parser_spec():
    ...
    parser.add_argument(
        ...
        default=None,
        help=
        "The path to the UNet model to be converted. If not specified, the UNet model from the pipeline will be used."
        )
